...
<div class="min-h-[70vh] flex items-center justify-center">
  <div class="card max-w-lg w-full" style="padding: 2.5rem 2rem;">
    <div class="text-center mb-2">
      <span class="text-2xl">{['👋', '📸', '✍️', '📏', '🎨'][step - 1]}</span>
    </div>
    ...
    {#if step === 1}
      <div class="text-center">
        ...
        <input class="input text-center text-lg" bind:value={name} placeholder="Your name" style="font-size: 1.125rem;" />
      </div>
    {:else if step === 2}
      <div class="text-center">
        <h2 class="text-xl font-bold mb-4">Profile photo</h2>
        {#if avatar}
          <img src={avatar} alt="" class="w-20 h-20 rounded-full mx-auto mb-4 object-cover" style="border: 2px solid var(--border);" />
        {/if}
    ...
    {:else if step === 3}
      <div class="text-center">
        ...
        <textarea class="input text-center" style="min-height: 100px; resize: none;" bind:value={bio} placeholder="Tell us about yourself as a runner..."></textarea>
      </div>
    {:else if step === 4}
      <div class="text-center">
